...
//		absInvoice.setInvoiceContent(InvoiceContentEnum.INVOICE_CONTENT_01.getKey());
	...
	/*
	 * private String transferFpType(String fpType) { String str = null;
	 * if(!StringUtils.isEmpty(fpType)) { switch (fpType) { case "00": str =
	 * FpTypeEnum.ELECTRONIC_GENERAL_INVOICE.getValue(); break; case "01": str =
	 * FpTypeEnum.PAPER_GENERAL_INVOICE.getValue(); break; case "02": str =
	 * FpTypeEnum.PAPER_SPECIAL_INVOICE.getValue(); break; default: str =
	 * FpTypeEnum.PAPER_GENERAL_INVOICE.getValue(); break; } } return str; }
	 * 
	 * private String transferInvoiceType(String invoiceType) { String str = null;
	 * if(!StringUtils.isEmpty(invoiceType)) { switch (invoiceType) { case "001":
	 * str = InvoiceTypeEnum.PERSONAL.getValue(); break; case "002": str =
	 * InvoiceTypeEnum.ENTERPRISE.getValue(); break; default: str =
	 * InvoiceTypeEnum.PERSONAL.getValue(); break; } } return str; }
	 */
	
	/*
	 * private String transferInvoiceStatus(String invoiceStatus) { String str =
	 * null; if(!StringUtils.isEmpty(invoiceStatus)) { switch (invoiceStatus) { case
	 * "000": str = InvoiceStatusEnum.UN_INVOICED.getValue(); break; case "001": str
	 * = InvoiceStatusEnum.INVOICED.getValue(); break; default: str =
	 * InvoiceStatusEnum.UN_INVOICED.getValue(); break; } } return str; }
	 * 
	 * private String transferInvoiceContent(String invoiceContent) { String str =
	 * null; if(!StringUtils.isEmpty(invoiceContent)) { switch (invoiceContent) {
	 * case "01": str = InvoiceContentEnum.INVOICE_CONTENT_01.getValue(); break;
	 * case "02": str = InvoiceContentEnum.INVOICE_CONTENT_02.getValue(); break;
	 * default: str = InvoiceContentEnum.INVOICE_CONTENT_01.getValue(); break; } }
	 * return str; }
	 */
}
